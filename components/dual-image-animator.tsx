              ...
              <>
                <div className="relative w-full h-full">
                  ...
                  <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
                    ...
                    <span className="text-white font-extrabold text-2xl md:text-3xl lg:text-4xl drop-shadow-md relative z-10 text-center tracking-wide">RAINBOW <br /> DOOD</span>
                  </div>
                  <Button
                    variant="outline"
                    size="icon"
              ...
              <>
                <div className="relative w-full h-full">
                  ...
                  <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-b from-black/40 to-black/10"></div>
                    <span className="text-white font-extrabold text-lg drop-shadow-md relative z-10">UPLOAD</span>
                    <span className="text-white font-extrabold text-2xl md:text-3xl lg:text-4xl drop-shadow-md relative z-10 text-center tracking-wide">SILHOU <br /> DOOD</span>
